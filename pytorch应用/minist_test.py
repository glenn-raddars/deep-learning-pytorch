...
#下载数据集    28*28=784
dataset_train = torchvision.datasets.MNIST(root="./课件和数据集/minist", train=True, transform=torchvision.transforms.ToTensor(), download=False)
dataset_test = torchvision.datasets.MNIST(root='./课件和数据集/minist', train=False, transform=torchvision.transforms.ToTensor(), download=False)
