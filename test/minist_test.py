...
#下载数据集    28*28=784
dataset_train = torchvision.datasets.MNIST(root='./test', train=True, transform=torchvision.transforms.ToTensor(), download=True)
dataset_test = torchvision.datasets.MNIST(root='./test', train=False, transform=torchvision.transforms.ToTensor(), download=False)
